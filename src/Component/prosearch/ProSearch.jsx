...
const [allproduct, setAllproduct] = useState(null);
    ...
    <input type="search" onChange={function(e){setInputValue(e.target.value)}} className='form-control w-50 m-auto mt-5' placeholder='Start Search With Captail Character......' id='search'/>
