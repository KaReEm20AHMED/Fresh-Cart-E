    ...
    <div className="col-md-9 m-0 p-0">
        <Slider {...settings}>
          <div className="m-0 p-0">
            <img src={require("../../images/13.gif")} className="w-100 p-0 m-0" alt="img" style={{ height:"400px" }} />
          </div>
          <div className="m-0 p-0">
          ...
          <div className="m-0 p-0">
           <img src={require("../../images/18.png")} className="w-100 p-0 m-0" alt="img" style={{ height:"400px" }} />
          </div>
          <div className="m-0 p-0">
            <img src={require("../../images/19.gif")} className="w-100 p-0 m-0" alt="img" style={{ height:"400px" }} />
          </div>
          <div className="m-0 p-0">
            <img src={require("../../images/4.jpg")} className="w-100 p-0 m-0" alt="img" style={{ height:"400px" }} /> 
          </div>
        </Slider>
    </div>
    <div className="col-md-3 m-0 p-0 my-0 py-0">
        ...
        <Slider {...settings} className="m-0 p-0">
          <div className="m-0 p-0" style={{ height:"190px" }}>
            <img src={require("../../images/2.jpg")} className="w-100 m-0 p-0" alt="img" style={{ height:"197px" }} />
          </div>
          <div className="m-0 p-0" style={{ height:"190px" }}>
             <img src={require("../../images/14.gif")} className="w-100 m-0 p-0" alt="img" style={{ height:"197px" }} />
          </div>
          <div className="m-0 p-0" style={{ height:"190px" }}>
        ...
        <Slider {...settingsf} className="m-0 p-0">
          <div className="m-0 p-0" style={{ height:"190px" }}>
            <img src={require("../../images/3.jpg")} className="w-100 m-0 p-0" alt="img" style={{ height:"197px" }} />
          </div>
          <div className="m-0 p-0" style={{ height:"190px" }}>
             <img src={require("../../images/17.webp")} className="w-100 m-0 p-0" alt="img" style={{ height:"197px" }} />
          </div>
          <div className="m-0 p-0" style={{ height:"190px" }}>
            <img src={require("../../images/latest_fashion_trends.jpg")} className="w-100 m-0 p-0" alt="img" style={{ height:"197px" }} />
          </div>
        ...
        <div className="row g-4 m-0 p-0 ">
          {data?.data.data.map(function (elm, idx) {
            return (
              <div
                key={idx}
                className="col-md-2 position-relative main"
